...
| **french-revolution.md** | FACTION DEATH (фракции уничтожаются), Suspicion meter, Era Shifts, Denouncement, Revolutionary Tribunal | 1789-1799. Уникальная механика: фракции НЕ статичны — полностью уничтожаются (Жирондисты → казнены, Дантонисты → казнены). Suspicion вместо Heat (донос снижает). Era Shifts — мир меняется, вчерашний герой = враг народа. Роли: Санкюлот, Аристократ (выживание/побег), Солдат, Журналист (Марат), Шпион, Буржуа. Война на фоне: Коалиции, Вандея. Референсы: Scarlet Pimpernel, Danton (фильм), Les Misérables (эпоха). |
